...
![v-text](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/20200229165916.png)

#### 4、v-pre

v-pre 用于跳过这个元素和它子元素的编译过程，显示原本的插值语法，将代码原封不动的解析出来

![v-pre](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/20200229170436.png)

### 绑定属性v-bind

#### 1、v-bind基础用法
插值语法中可以实现对data的动态绑定，对于其它入src，href等属性我们可以使用`v-bind`实现。这时，可以使用`v-bind` 指令来动态绑定属性，`v-bind`用于绑定一个或多个属性值，或者向另一个组件传递 props值
![v-bind使用1](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/20200229171716.png)
...
***应用：***
![v-bind绑定class](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/20200229173755.png)
...
![](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/markdownpic/20200305203810.png)
...
![](https://blog-1257711631.cos.ap-nanjing.myqcloud.com/markdownpic/20200305164748.png)
